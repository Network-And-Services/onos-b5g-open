 ...
 * //CHECKSTYLE:ON
 */
public class HhiTerminalDeviceDiscovery
    ...
    public DeviceDescription discoverDeviceDetails() {
        ...
        try {
            ...
            vendor       = xconf.getString("data.components.component.name", vendor);
    ...
    private PortDescription parsePortComponent(
        ...
        // Assing an ONOS port number manually
        PortNumber portNum = PortNumber.portNumber(1011);
        log.warn("PORT {} number {}", name, portNum);
