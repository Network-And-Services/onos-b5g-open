...
screen -dmS t1 -T xterm sh -c 'docker run --net=netbr0 --ip=10.100.101.21 --name octp1 -it octmm.img:latest ./startNetconfAgent.sh'
sleep 2

echo "--- OCTP-2 screen t2 IP 10.100.101.22"
screen -dmS t2 -T xterm sh -c 'docker run --net=netbr0 --ip=10.100.101.22 --name octp2 -it octmm.img:latest ./startNetconfAgent.sh'
sleep 2

echo "--- OCTP-3 screen t3 IP 10.100.101.23"
screen -dmS t3 -T xterm sh -c 'docker run --net=netbr0 --ip=10.100.101.23 --name octp3 -it octmm.img:latest ./startNetconfAgent.sh'
sleep 2

echo "--- OCTP-4 screen t4 IP 10.100.101.24"
screen -dmS t4 -T xterm sh -c 'docker run --net=netbr0 --ip=10.100.101.24 --name octp4 -it octmm.img:latest ./startNetconfAgent.sh'
sleep 2
