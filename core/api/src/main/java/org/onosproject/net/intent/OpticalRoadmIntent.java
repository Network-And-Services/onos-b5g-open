 ...
 * This intent is assumed between two Och ports on the ROADMs
 */
@Beta
public final class OpticalRoadmIntent extends Intent {
    ...
    private OpticalRoadmIntent(ApplicationId appId,
                               Key key,
                               ConnectPoint src,
                               ConnectPoint dst,
                               Path path,
    ...
    public static class Builder extends Intent.Builder {
         ...
         */
        public OpticalRoadmIntent build() {

            return new OpticalRoadmIntent(
                    appId,
                    key,
                    src,
                    dst,
